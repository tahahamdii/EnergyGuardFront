    ...
    <li className="relative">
      ...
      >
        ...
        <ul className="flex h-auto flex-col overflow-y-auto">
          {/* Static Notification */}
          <li>
            <div className="flex flex-col gap-2.5 border-t border-stroke px-4.5 py-3 bg-red-100 dark:bg-red-700 dark:border-red-700">
              <p className="text-sm text-red-600 dark:text-red-200">
                <span className="text-black dark:text-white">
                  Important Notification:
                </span>{' '}
                Your account needs attention. Please take action.
              </p>

              <p className="text-xs">Today</p>
            </div>
          </li>
          {/* End Static Notification */}
          {/* Other Notifications */}
          <li>
            <Link
