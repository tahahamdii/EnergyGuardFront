    ...
    import { logLogout, setUserActivities } from '../../state/Activity/ActivitySlice';
    ...
    const DropdownUser = () => {
      ...
      const logout = async (e: React.FormEvent) => {
        ...
        try {
          ...
          const response = await fetch(`http://localhost:5000/userActivity/addAllActivity/${username}`, {
            method: 'POST',
            headers: {
