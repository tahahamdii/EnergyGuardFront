...
function CollapsibleExample() {
  ...
  return (
    <Navbar expand="xl" collapseOnSelect className="sticky top-0 z-999 bg-white" data-bs-theme="light">
      <Container fluid>
        <Navbar.Toggle aria-controls="navbarScroll" />
        <Navbar.Collapse id="navbarScroll">
          <Nav className="me-auto my-2 my-lg-0" navbarScroll>
            <div style={{ marginRight: '20px', display: "flex", alignItems: "center", color: "black",marginLeft:"50px" }}>
            ...
            <div style={{ marginRight: '20px', marginLeft: '20px', display: "flex", alignItems: "center", color: "black" }}>
              ...
              <Nav.Link href="#action1">Fichier</Nav.Link>
            </div>
            <div style={{ marginRight: '20px', display: "flex", alignItems: "center", color: "black" }}>
              ...
              <Nav.Link href="#action2">Facture energie</Nav.Link>
            </div>
            <div style={{ marginRight: '20px', display: "flex", alignItems: "center", color: "black" }}>
              ...
              <NavDropdown title="Compteur energie" id="basic-nav-dropdown">
    
              <NavDropdown.Item as={Link} to="/bilan">Bilan</NavDropdown.Item>
              <NavDropdown.Item href="#action/3.3">Journalisation</NavDropdown.Item>
            ...
            <div style={{ marginRight: '20px', display: "flex", alignItems: "center", color: "black" }}>
              ...
              <Nav.Link href="#action2">revue energitique</Nav.Link>
            </div>
            <div style={{ marginRight: '20px', display: "flex", alignItems: "center", color: "black" }}>
